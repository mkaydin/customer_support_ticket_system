        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedToUserId = table.Column<string>(type: "NVARCHAR2(450)", nullable: true),
                    AdminNotes = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
                    SolvedAt = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    SolvedByUserId = table.Column<string>(type: "NVARCHAR2(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tickets_AspNetUsers_SolvedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_SolvedByUserId",
                table: "Tickets",
